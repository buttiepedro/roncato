...
export default function SideBar() {
  ...
  const menuItems = [
    ...
    { path: "/productos", label: "Productos", icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25v8.25m0-8.25a2.25 2.25 0 0 0-1.06-1.91l-5.143-3.214a2.25 2.25 0 0 0-2.388 0L7.266 6.34A2.25 2.25 0 0 0 6.206 8.25m14.794 0-6.75 4.218m-8.044-4.218v8.25m0-8.25a2.25 2.25 0 0 1 1.06-1.91l5.143-3.214a2.25 2.25 0 0 1 2.388 0l5.143 3.214a2.25 2.25 0 0 1 1.06 1.91m-14.794 0 6.75 4.218m0 0 6.75-4.218m-6.75 4.218v8.25" />
      </svg>
    )},
    { path: "/entregas-parciales", label: "Entregas", icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
